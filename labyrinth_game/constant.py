...
ROOMS = {
    ...
    "kitchen": {
        "description": (
            "В этой комнате полно еды!"
        ),
        "exits": {"north": "library", "south": "living_room"},
        "items": ["beef", "chicken"],
        "puzzle": None,
    },
    "living_room": {
        "description": ("Спальня с большой кроватью и часами на тумбе."),
        "exits": {"north": "kitchen"},
        "items": ["bed", "clock"],
        "puzzle": (
            "Кукушка вылетает из часов ровно в полдень. "
            "Сколько раз в день кукушка вылетает из часов",
            "1",
        ),
    },
}
